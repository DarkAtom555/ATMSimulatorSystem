...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        mariButtonGroup.add(unmarried);
        mariButtonGroup.add(other);
    ...
    public void actionPerformed(ActionEvent ae){
            String formno = ""+random;//long convert to string
            ...
            try{
             ...
             else  if(marital.equals("")) JOptionPane.showMessageDialog(null, "Marital Status is Required");
             else  if(address.equals("")) JOptionPane.showMessageDialog(null, "Address is Required");
             else  if(city.equals("")) JOptionPane.showMessageDialog(null, "Cityname is Required");
             else  if(state.equals("")) JOptionPane.showMessageDialog(null, "Statename is Required");
